...
| light | rgba rgb | * | / | Defines Thing emitting light.<br />The parameter is RGBA followed by RGB color vector. The RGB overrides the color components in first RGBA parameter. The 4th component in RGBA (i.e. alpha) represents alpha and min & max light radius.<br/>To use this param at least 1 RGB color component > 0.0 and alpha color component > 0.01.<br/>There can be max 64 lights and lightintensity defined in the level.<br />i.e. 64 Things can have either light or lightintensity parameter set.|
